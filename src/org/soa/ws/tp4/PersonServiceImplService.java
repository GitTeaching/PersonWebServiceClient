 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://tp4.ws.soa.org/", wsdlLocation = "http://hedia:8080/PersonWebService/PersonServiceImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://tp4.ws.soa.org/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://hedia:8080/PersonWebService/PersonServiceImplService?wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://tp4.ws.soa.org/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp4.ws.soa.org/", "PersonServiceImplPort"), PersonService.class, features);
    }
